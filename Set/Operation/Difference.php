...
class Zrt_Set_Operation_Difference
        extends Zrt_Set_Operation_Abstract
    {
    ...
    public function __call( $method , $arguments )
        ...
        if ( !method_exists( $this->_setInterface , $method ) )
            {
            throw new Zrt_Exception( "$method is not defined in $this->_setInterface" );
            }
    ...
    public function addExclude( $element )
        {
        if ( $element instanceof $this->_setInterface || $element instanceof Zrt_Set_Operation_Abstract )
            {
            $this->_excludes[] = $element;
            }
        else
            {
            throw new Zrt_Exception( "Element must implement $this->_setInterface or Set" );
            }
