 ...
 * @license    http://code.google.com/p/zfdebug/wiki/License     New BSD License
 */
class Zrt_Controller_Plugin_Debug_Plugin_Text implements Zrt_Controller_Plugin_Debug_Plugin_Interface
{
    /**
     * @var string
     */
    ...
    /**
     * Create Zrt_Controller_Plugin_Debug_Plugin_Text
     *
     * @param string $tab
     * @paran string $panel
     * @return void
     ...
     *
     * @param string $name
     * @return Zrt_Controller_Plugin_Debug_Plugin_Text Provides a fluent interface
     */
