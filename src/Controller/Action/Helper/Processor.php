...
class Zrt_Controller_Action_Helper_Processor
    ...
    protected function _getControllerProcessor()
        ...
        if (null === $this->_processor) {
            ...
            $class = 'Zrt_Controller_Processor_' . ucfirst( $context );
    ...
    public function __call($method , $arguments)
        ...
        if ( !method_exists( $this->_getControllerProcessor() , $method ) ) {
            throw new Zrt_Exception( "Unknown method" );
            }

        return call_user_func_array( array( $this->_getControllerProcessor() , $method ) ,
                                     $arguments );
