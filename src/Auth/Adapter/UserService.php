...
class Zrt_Auth_Adapter_UserService
    ...
    public function __construct($userClass)
        ...
        if ( !in_array( 'Zrt_Model_Service_User_Interface' ,
            ...
            {
            throw new Zend_Auth_Adapter_Exception( "$userClass must implement Zrt_Model_Service_User_Interface" );
            }
    ...
    public function authenticate()
        ...
        $results = $userClass::findByIdentityAndCredential( $this->_identity ,
                                                            $this->_credential );
