 ...
 * @license    http://code.google.com/p/zfdebug/wiki/License     New BSD License
 */
class Zrt_Controller_Plugin_Debug extends Zend_Controller_Plugin_Abstract
{
    ...
    public function __construct($options = null)
    {
         ...
         */
        $version = new Zrt_Controller_Plugin_Debug_Plugin_Text();
         ...
         */
        $logger = new Zrt_Controller_Plugin_Debug_Plugin_Log();
     ...
     *
     * @param Zrt_Controller_Plugin_Debug_Plugin_Interface
     * @return Zrt_Controller_Plugin_Debug
     */
    public function registerPlugin(Zrt_Controller_Plugin_Debug_Plugin_Interface $plugin)
    {
    ...
    protected function _loadPlugins()
    {
        foreach ($this->_options['plugins'] as $plugin => $options) {
            ...
            if (is_object($plugin) && in_array('Zrt_Controller_Plugin_Debug_Plugin_Interface',
            ...
            if (in_array($plugin,
                    Zrt_Controller_Plugin_Debug::$standardPlugins)) {
                // standard plugin
                $pluginClass = 'Zrt_Controller_Plugin_Debug_Plugin_' . $plugin;
            } else {
