...
abstract class Zrt_Model_Rowset
    ...
    protected function _prepareReference( Zend_Db_Table_Abstract $dependentTable ,
                                          ...
                                          $ruleKey )
        {
        $map = $dependentTable->getReference( get_class( $parentTable ) ,
                                                         $ruleKey );
    ...
    public function findDependentRowset( $dependentTable , $ruleKey = null ,
        ...
        $map = $this->_prepareReference( $dependentTable , $this->getTable() ,
                                         $ruleKey );
        ...
        for ( $i = 0; $i < count( $map[Zend_Db_Table_Abstract::COLUMNS] ); ++$i )
            ...
            $dependentColumn = $dependentDb->quoteIdentifier( $dependentColumnName ,
                                                              true );
