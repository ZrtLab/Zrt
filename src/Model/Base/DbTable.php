...
abstract class Zrt_Model_Base_DbTable
    ...
    public function __construct( $config = array( ) )
        {
        $this->setDefaultAdapter( Zrt_Db::getAdapter( Zrt_Db::getDefaultAdapterName() ) );
    ...
    public function getLookupReference( $column )
        ...
        if ( !isset( $this->_lookupReferences[$column] ) )
            {
            throw new Zrt_Exception( "'$column' is not a referenced column." );
            }
