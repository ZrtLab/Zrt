 ...
 */
class Zrt_Temporal_Expression_MonthsFromStart
        implements Zrt_Temporal_Expression_Interface
    {
    ...
    public function includes( $date )
        ...
        return (0 == ((date( 'n' , strtotime( $date ) ) - date( 'n' ,
                                                                strtotime( $this->_start ) )) % $this->_count));
