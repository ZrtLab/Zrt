...
//			->addDecorator('Form');
    ...
    public function setPageLimit( $pageLimit )
        ...
        if ( !is_int( $pageLimit ) )
            {
            throw new Zrt_Exception( "Page Limit must be an integer!" );
            }
