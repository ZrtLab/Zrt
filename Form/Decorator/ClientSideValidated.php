...
class Zrt_Form_Decorator_ClientSideValidated extends Zend_Form_Decorator_Abstract {
...
(function($) {
	Zrt.Validation.Rules["$formName"] = $constraints;
})(jQuery);
FORM_VALIDATION;
	}
...
//			->addValidation($form->getInternalName());
		...
		if (Zend_Controller_Front::getInstance()->getRequest()->isPost()) {
			$jQuery->addJavascript("Zrt.Validation.validateOnLoad = true;");
		}
