...
class Zrt_Db_Document_FacebookSet
        implements Iterator ,
                   Countable ,
                   ArrayAccess
    {
    ...
    public function __construct( $config )
        ...
        if ( isset( $config['data'] ) )
            ...
            elseif ( is_array( $data ) )
                ...
                {
                throw new Zrt_Exception( "Invalid data provided." );
                }
            }
     ...
     *
     * @param array|Zrt_Db_Document_Facebook $document
     */
    public function add( $document )
        {
        if ( is_array( $document ) )
            {
            $document = new Zrt_Db_Document_Facebook( array(
                        'adapter' => $this->getAdapter() ,
                        'data' => $document
                    ) );
            }
        elseif ( !$document instanceof Zrt_Db_Document_Facebook )
            {
            throw new Zrt_Exception( "Invalid document specified." );
            }
