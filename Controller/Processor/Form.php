...
class Zrt_Controller_Processor_Form
        extends Zrt_Controller_Processor
    {
    ...
    public function success( Zrt_Model $record )
        ...
        $description = $service::getDescription( $record );
        Zrt_Feedback::add( Zrt_Feedback::INFO ,
    ...
    public function invalid( Zrt_Model $record )
        {
        $this->_fail( $record ,
                      "One or more fields were invalid.  Please check your data and try again." );
    ...
    protected function _fail( Zrt_Model $record , $message )
        {
        Zrt_Feedback::add( Zrt_Feedback::ERROR , $message );
