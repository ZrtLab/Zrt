 ...
 * @package Zrt_Controller
 */
class Zrt_Controller_Plugin_MultiTenanting
    ...
    public function __construct( $databaseAdapterName , $tenantClass ,
        ...
        if ( !in_array( 'Zrt_MultiTenant_Service_Tenant_Interface' ,
                        class_implements( $tenantClass ) ) )
            {
            throw new Zrt_Exception( "Tenant Class must implement Zrt_MultiTenant_Service_Tenant_Interface" );
            }
        ...
        if ( null !== $resellerClass )
            ...
            if ( !in_array( 'Zrt_MultiTenant_Service_Reseller_Interface' ,
                ...
                {
                throw new Zrt_Exception( "Reseller Class must implement Zrt_MultiTenant_Service_Reseller_Interface" );
                }
